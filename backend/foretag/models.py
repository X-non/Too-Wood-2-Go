...
class Store(models.Model):
    ...
    credentials = models.CharField(max_length=50, default="Not connected") #TODO - Implement refrence to login
...
class Reservation(models.Model):
    ...
    claimer = models.CharField(max_length=100, default="not claimed yet!") #TODO - Foreign key till Users
